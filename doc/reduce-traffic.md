...
By default, Randycoin Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that randycoin's trustless model works best if you are
