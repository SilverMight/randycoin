# Support for Output Descriptors in Randycoin Core

Since Randycoin Core v0.17, there is support for Output Descriptors. This is a
...
on Randycoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Randycoin Core wallets, a convenience function `combo` is
