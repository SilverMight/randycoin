...
"""Verify that starting randycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start randycoin with -h for help text")
        ...
        self.log.info("Start randycoin with -version for version information")
        ...
        self.log.info("Start randycoind with -fakearg to make sure it does not start")
