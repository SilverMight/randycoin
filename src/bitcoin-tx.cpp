...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " randycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  randycoin-tx [options] <hex-tx> [commands]  Update hex-encoded randycoin transaction\n" +
            "or:     randycoin-tx [options] -create [commands]   Create hex-encoded randycoin transaction\n" +
            "\n";
